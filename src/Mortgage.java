...
public class Mortgage {
  ...
  public void storeLoanAmount() {
    ...
    while (true) {
      ...
      if (!reEnter) {
        ...
        System.out.print(
          "Please re-enter loan amount without $ or commas (Ex:120000): "
        );
      }
  ...
  /**
   * Reads in from the user, validates, and stores the yearly interest rate of
   * the loan.
   */
  public void storeInterestRate() {
    ...
    while (true) {
      ...
      if (!reEnter) {
        ...
        System.out.print(
          "Please re-enter valid yearly interest rate (Ex: 8.25): "
        );
      }
      // remove characters that aren't digits or a decimal points
      input = s.nextLine().trim().replaceAll("[^0-9.]", " ");
  ...
  /**
   * @param amount the new loan amount (i.e. principal) of this {@code Mortgage}
   *   (in dollars)
  ...
  /**
   * @param term the new interest rate of this {@code Mortgage} (as a
   *   percentage)
